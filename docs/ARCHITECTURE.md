...
| `validation.rs`      | Pre-side-effect checks, path normalization, duplicate concrete targets, sync-delete target overlap, strict sync rejection, command cwd/env checks.                               | Parsing or filesystem mutation.                                                                              |
