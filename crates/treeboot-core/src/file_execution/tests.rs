...
fn execute_file_operation_group_should_reject_metadata_repair_through_symlink_parent() {
    if skip_without_symlinks(
        "execute_file_operation_group_should_reject_metadata_repair_through_symlink_parent",
    ) {
        return;
    }
...
fn execute_file_operation_group_should_reject_canonical_target_with_context_alias() {
    if skip_without_symlinks(
        "execute_file_operation_group_should_reject_canonical_target_with_context_alias",
    ) {
        return;
    }
